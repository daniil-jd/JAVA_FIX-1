...
public class UsersDaoJdbcTemplateImpl implements UsersDao {
    ...
    //language=SQL
    private final String SQL_BY_FIRST_NAME_PREFIX =
            "SELECT *\n" +
                    "FROM fix_user WHERE first_name LIKE :prefix;";
    ...
    @Override
    public List<User> findAllByFirstNamePrefix(String firstNamePrefix) {
        Map<String, Object> params = new HashMap<>();
        params.put("prefix", firstNamePrefix + "%");
        return namedParameterJdbcTemplate.query(SQL_BY_FIRST_NAME_PREFIX, params, userRowMapperWithoutCars);
    }
